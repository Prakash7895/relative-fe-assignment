...
interface TrendingCardProps {
	...
	children: ReactNode;
	className?: string;
	headerElementContainerStyle?: string;
}
		...
		<div className={`flex flex-col items-center ${className}`}>
			<div className='flex flex-row w-full items-end'>
				...
				<div className='h-28 w-28 relative'>
					...
					>
						<div
							className={`border rounded-full h-full w-full flex justify-center items-center ${headerElementContainerStyle}`}
							style={{
								// background: gradientFromColor,
								borderColor: borderColor,
							}}
...
TrendingCard.defaultProps = {
	...
	headerElementContainerStyle: 'bg-red-300',
};
